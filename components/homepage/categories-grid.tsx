    ...
    return (
        <div className="w-full bg-white py-4 shadow-sm rounded-2xl">
            <div className="container mx-auto px-4 relative">
                ...
                <MoveBackCarouselBtn position={"left-0"} hover={"-left-1"} scrollPrev={scrollPrev} prevBtnEnabled={prevBtnEnabled}/>
                <MoveNextCarouselBtn position={"right-0"} hover={"-right-1"} scrollNext={scrollNext} nextBtnEnabled={nextBtnEnabled}/>
            </div>
        </div>
    )
}
