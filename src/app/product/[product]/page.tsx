...
import ProductImages from "@/src/components/product/detail/product-image";
import RatingStars from "@/src/components/ui/rating-stars";
import ProductAction from "@/src/components/product/detail/product-action";
import ProductSpecifications from "@/src/components/product/detail/product-specifications";
import CustomerReviews from "@/src/components/product/detail/customer-review/customer-reviews";
import ProductDescription from "@/src/components/product/detail/product-description";
import ShopInfoCard from "@/src/components/product/detail/shop-info-card";
