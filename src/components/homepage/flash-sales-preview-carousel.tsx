"use client";
import ProductCarousel from "@/src/components/product/product-carousel";
import * as React from "react";
import {CompactDisplayFlashSaleProps} from "@/src/interfaces/product";
import CompactFlashSaleProductCard from "@/src/components/product/card/compact-flash-sale-product-card";
import CountDownClock from "@/src/components/homepage/count-down-clock";
