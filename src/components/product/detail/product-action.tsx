import QuantityInput from "@/src/components/form/quanitty-input";
import {MapPin} from "lucide-react";
import {Button} from "@/src/components/ui/button";
import ShoppingCartPlus from "@/src/components/icon/shopping-cart-plus";
...
export default function ProductAction() {
    return (
        <div>
            ...
            <Button className="w-full  mt-2 border-custom-1 text-custom-1 hover:text-custom-1 hover:bg-custom-1/10"
                    variant={"outline"}>
