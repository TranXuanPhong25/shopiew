                ...
                <div>
                    <div className="flex my-2">
                        <div className="relative">
                            ...
                            />
                            <div
                                className="absolute right-0 bottom-0 size-3 bg-gray-400 rounded-full -translate-x-1/2 -translate-y-1/2 outline-4 outline-white outline"/>
                        </div>
                        <div className="flex flex-col justify-center ml-2">
                            <div className="font-bold flex gap-1">FOCALLURE Beauty.VN <BadgeCheckIcon
                                className="size-5  text-green-400"/></div>
                            <div className="text-muted-foreground text-sm flex gap-1"><MapPinHouse className="size-4"/>Hanoi,
                                Vietnam
                            </div>
                        </div>
                    </div>
