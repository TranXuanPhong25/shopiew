    ...
    return (
        <Card className="max-w-sm overflow-hidden">
            <div className="relative">
                {/* Promotional banner */}
                <div
                    className="absolute top-0 left-0 right-0 z-10 bg-red-500 text-white text-center py-1 text-sm font-medium">
                    MUA 1 TẶNG QUÀ 710K
                </div>
            ...
            <CardContent className="p-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span
                        className="text-sm text-muted-foreground">-{100 - Math.round(product.salePrice / product.originalPrice * 100)}%</span>
                </div>
