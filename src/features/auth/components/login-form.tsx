...
export default function LoginForm({
   ...
   const onSubmit = async (data: LoginFormValues) => {
      ...
      try {
         ...
         // You could redirect the user or update auth state here
      } catch (err: any) {
   ...
   return (
      <Card className={cn("overflow-hidden p-0 ", className)} {...props}>
         <CardContent className="grid p-0 md:grid-cols-2">
            <div className="p-6 md:p-8 w-[400px]">
               <Form {...form}  >
                  <div className="flex flex-col gap-6">
                     <div className="flex flex-col items-center text-center">
                        <h1 className="text-2xl font-bold">Welcome back</h1>
                        <p className="text-muted-foreground text-balance">
                           Login to your Shopiew account
                        </p>
                     </div>
            ...
            <div className="bg-[#E4E4E7] relative hidden md:block">
               <Image
