                            ...
                            <div className="space-y-6">
                                ...
                                <div className="pt-4 border-t border-gray-200">
                                    <p className="text-xs text-gray-500 leading-relaxed">
                                        ...
                                        <a href="#" className="text-blue-600 hover:text-blue-700"> Điều khoản dịch vụ</a> và 
                                        <a href="#" className="text-blue-600 hover:text-blue-700"> Chính sách quyền riêng tư</a> của chúng tôi.
                                    </p>
                                </div>
                            </div>
                        </Card>
