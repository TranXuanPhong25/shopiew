...
import { Package, Clock, CheckCircle, Truck, XCircle, RotateCcw, TrendingUp, DollarSign } from 'lucide-react';
import { useOrderStats } from '@/hooks/use-orders';
import { Skeleton } from '@/components/ui/skeleton';

const OrdersPage = () => {
   const { stats, loading, fetchStats } = useOrderStats();
   ...
   return (
      <div className="space-y-6 p-6">
         ...
         <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
               <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium">Hủy / Trả hàng</CardTitle>
               ...
               <CardContent>
                  {loading ? (
                     ...
                     <div className="text-2xl font-bold">{displayStats.cancelled + displayStats.returns}</div>
                  )}
                  <p className="text-xs text-muted-foreground">
                     {displayStats.cancelled} hủy, {displayStats.returns} trả hàng
                  </p>
               </CardContent>
            </Card>
         </div>
                  ...
                  <Card className="cursor-pointer transition-all hover:shadow-md hover:border-orange-300">
                     ...
                     <CardContent>
                        {loading ? (
                           ...
                           <div className="text-2xl font-bold">{displayStats.pendingConfirmation}</div>
                        )}
                        <p className="text-xs text-muted-foreground">
                  ...
                  <Card className="cursor-pointer transition-all hover:shadow-md hover:border-blue-300">
                     ...
                     <CardContent>
                        {loading ? (
                           ...
                           <div className="text-2xl font-bold">{displayStats.processing}</div>
                        )}
                        <p className="text-xs text-muted-foreground">
                           Đang chuẩn bị hàng
                        </p>
                  ...
                  <Card className="cursor-pointer transition-all hover:shadow-md hover:border-purple-300">
                     ...
                     <CardContent>
                        {loading ? (
                           ...
                           <div className="text-2xl font-bold">{displayStats.shipping}</div>
                        )}
                        <p className="text-xs text-muted-foreground">
                           Đang vận chuyển
                        </p>
                  ...
                  <Card className="cursor-pointer transition-all hover:shadow-md hover:border-amber-300">
                     ...
                     <CardContent>
                        {loading ? (
                           ...
                           <div className="text-2xl font-bold">{displayStats.returns}</div>
                        )}
                        <p className="text-xs text-muted-foreground">
                           Yêu cầu hoàn trả
                        </p>
         ...
         <div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
               <Card>
                  <CardHeader>
                     <CardTitle className="text-base">Xem tất cả đơn hàng</CardTitle>
                     <CardDescription>
               ...
               <Card>
                  <CardHeader>
                     <CardTitle className="text-base">Cài đặt vận chuyển</CardTitle>
                     <CardDescription>
