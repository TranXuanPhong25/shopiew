				...
				<>
					<div className="grid md:grid-cols-2 gap-6">
						<div>
							...
							>
								<span className="text-red-500">*</span> Giá gốc
							</Label>
							<div>
					...
					<div className="grid md:grid-cols-2 gap-6">
						<div className=" ">
							<Label
								...
								className="text-base font-normal gap-1 flex items-center"
							>
					...
					<div className="">
						...
						>
							...
							<TooltipProvider>
								<Tooltip>
									...
									<TooltipContent>
										<p>
											Số lượng tối đa khách hàng có thể mua trong một
											đơn hàng.
										</p>
									</TooltipContent>
								</Tooltip>
						...
						<div>
							...
							{errors.maxPurchaseQuantity && (
								<p className="text-red-500 text-sm mt-1">
									{errors.maxPurchaseQuantity.message}
								</p>
							)}
						</div>
					</div>
