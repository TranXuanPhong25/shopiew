export interface EventBanner {
  ...
  priority: number
  isActive: boolean
  eventType: 'black_friday' | 'flash_sale' | 'new_year' | 'holiday' | 'seasonal' | 'other'
...
export interface CreateEventBannerRequest {
  title: string
  description?: string
  imageUrl: string
  linkUrl?: string
...
export interface CreatePromoBarRequest {
  message: string
  backgroundColor?: string
  textColor?: string
  linkUrl?: string
...
export interface UpdatePromoBarRequest {
  id: string
  message?: string
  backgroundColor?: string
  textColor?: string
