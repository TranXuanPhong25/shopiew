	...
	return (
		<div className=" bg-white rounded-2xl shadow-sm p-4">
			<div className="sm:flex ">
				<ProductImages
					images={[product.coverImage, ...product.images].map((image) => ({
						src: image,
						alt: product.name,
					}))}
				/>
				<div className={"flex-1 sm:ml-4"}>
					...
					<div className="flex items-center mb-2 hover:bg-gray-50/10 w-fit p-2 -mx-2 rounded-md ">
						<span className="ml-3 text-lg">{3.15}</span>
						<a href="#">
						...
						<span className="ml-2 font-sans  text-sm">352 sold</span>
					</div>
