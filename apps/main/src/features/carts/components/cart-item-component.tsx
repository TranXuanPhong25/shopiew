...
export function CartItemComponent({
	...
	const totalPrice = item.productVariant.salePrice * item.quantity;
	const discount =
		item.productVariant.originalPrice > item.productVariant.salePrice
			...
			<div className="flex item.productVariants-center gap-8">
				...
				<div className="min-w-[120px] flex justify-center">
					<QuantityInput
						...
						onChangeAction={() =>
							updateCartItem({
								productVariantID: Number.parseInt(
