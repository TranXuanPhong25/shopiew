				...
				<div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4 py-12">
					...
					<div>
						...
						<p className="text-sm text-gray-600 mb-4 text-pretty">
							Good & goods — Your trusted marketplace for quality
							products at great prices.
						</p>
						<p className="text-xs text-gray-500">
							Making online shopping simple, safe, and enjoyable for
							everyone.
						</p>
					</div>
					...
					<div>
						...
						<h3 className="mb-3 font-bold uppercase text-sm text-gray-700">
							Follow Us
						</h3>
